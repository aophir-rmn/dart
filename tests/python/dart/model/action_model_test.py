...
class ActionModelTests(unittest.TestCase):
    ...
    def test_action_model_with_data(self):
        ...
        self.assertEqual(str(self.actionModel), "updated='None', data='first_in_workflow='False', workflow_instance_id='None', on_success_email='[]', workflow_id='None', ecs_task_arn='None', on_failure='DEACTIVATE', user_id='anonymous', order_idx='None', state='HAS_NEVER_RUN', workflow_action_id='None', progress='None', extra_data='None', tags='[]', start_time='None', args='None', last_in_workflow='False', datastore_id='None', on_failure_email='[]', avg_runtime='None', name='action data name', engine_name='None', error_message='None', queued_time='None', end_time='None', action_type_name='test', completed_runs='0'', id='1', version_id='2', created='None'")
