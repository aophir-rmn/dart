...
from dart.model.dataset import Column, DataFormat, FileFormat, RowFormat, DatasetData, Dataset, LoadType
...
class TestEntityGraph(unittest.TestCase):
    def setUp(self):
        ...
        cs = [Column('c1', DataType.VARCHAR, 50), Column('c2', DataType.BIGINT)]
        df = DataFormat(FileFormat.PARQUET, RowFormat.NONE)
        dataset_data = DatasetData(name='test-dataset2-no-show', table_name='test_dataset_table2',
                                   load_type=LoadType.INSERT,
