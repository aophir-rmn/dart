...
from engine.emr import prepare_step_paths, hive_run_script_contents_step
...
def prepare_run_hive_script_steps(dry_run, datastore, action, script_contents):
    ...
    try:
        ...
        steps = [hive_run_script_contents_step(script_contents, s3_step_path, local_step_path, action.id, 1, 1)]
